...
SECRET_KEY = 'django-insecure-seygj2wn(lp3j7uh))af_e4qdzp)h_*^y9d49+ogy@rocvvbtg'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'category.context_pre_processor.get_all_category',
                'cart.context_preproser.cart_item_count'
            ],
        },
    },
]
